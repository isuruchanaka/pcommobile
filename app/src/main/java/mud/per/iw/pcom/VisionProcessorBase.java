...
public abstract class VisionProcessorBase<T> implements VisionImageProcessor {
    ...
    @Override
    public void process(ByteBuffer data, FrameMetadata frameMetadata, mud.per.iw.pcom.GraphicOverlay graphicOverlay) throws FirebaseMLException {
        latestImage = data;
    ...
    @Override
    public void process(Bitmap bitmap, mud.per.iw.pcom.GraphicOverlay graphicOverlay) {

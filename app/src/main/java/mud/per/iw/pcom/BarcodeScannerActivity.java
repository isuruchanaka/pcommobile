...
import mud.per.iw.pcom.BarcodeScanningProcessor.BarcodeResultListener;
...
import static mud.per.iw.pcom.BarcodeScanner.Constants.KEY_CAMERA_PERMISSION_GRANTED;
import static mud.per.iw.pcom.BarcodeScanner.Constants.PERMISSION_REQUEST_CAMERA;
...
public class BarcodeScannerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        barcodeOverlay=(GraphicOverlay)findViewById(R.id.barcodeOverlay);
